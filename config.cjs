...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Demo-Slayer~gFQ1TbBZ#PIWq4ndBKPMt3jCkvtEbOs2gMcdpGTZWVK2KUZGSRHI",
  ...
  REJECT_CALL: process.env.REJECT_CALL !== undefined ? process.env.REJECT_CALL === 'true' : trye,
